...
def chat(dialog, messages, stream=True, **kwargs):
    ...
    print("Tenant Id",dialog.tenant_id) #e7dd7eaecf7411ef955f0242ac120006
    print("LLMType.EMBEDDING", LLMType.EMBEDDING)
    print("embedding_model_name", embedding_model_name)
    # LLMBundle(e7dd7eaecf7411ef955f0242ac120006, embedding, text-embedding-3-small@OpenAI)
    ...
    print("Found embedding - 215", chat_mdl)
    bind_llm_ts = timer()

    prompt_config = dialog.prompt_config
    print("Found prompt config", prompt_config)
