...
DATABASE_TYPE = 'mysql' #os.getenv("DB_TYPE", 'mysql')

DBCONFG = {}
DBCONFG['name'] = 'rag_flow'
DBCONFG['user'] = 'root'
DBCONFG['password'] = 'infini_rag_flow'
DBCONFG['host'] = '44.212.5.246'
DBCONFG['port'] = 5455
DBCONFG['max_connections'] = 100
DBCONFG['stale_timeout'] = 30
#DATABASE = decrypt_database_config(name=DATABASE_TYPE)

DATABASE = DBCONFG #decrypt_database_config(name=DATABASE_TYPE)
...
def init_settings():
    ...
    LIGHTEN = 0 #int(os.environ.get('LIGHTEN', "0"))
    DATABASE_TYPE = 'mysql' #os.getenv("DB_TYPE", 'mysql')
    DATABASE = decrypt_database_config(name=DATABASE_TYPE)
    LLM = {} #get_base_config("user_default_llm", {})
    LLM_FACTORY = "OpenAI" #LLM.get("factory", "Tongyi-Qianwen")
